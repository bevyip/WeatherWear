...
document.addEventListener("DOMContentLoaded", function(event){
		...
		function renderCalendar(targetElem){
				...
				var dayNameElem = document.createElement("div"); // i.e.: Wednesday -> TODO: CHANGE to date stored
